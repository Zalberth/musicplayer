...
func (appui *AppGUI) Run() {
	...
	appui.forwardBtn = widget.NewButton("Forward", appui.IncreaseVol)
	appui.backwardBtn = widget.NewButton("Backward", appui.DecreaseVol)
...
func (appui *AppGUI) PlaySong() {
	if appui.newSongFlag || appui.curSong.over {
...
func (appui *AppGUI) IncreaseVol() {
	if appui.curSong.active {
		appui.curSong.increaseVol <- true
	}
}

func (appui *AppGUI) DecreaseVol()  {
	if appui.curSong.active {
		appui.curSong.decreaseVol <- true
	}
}
